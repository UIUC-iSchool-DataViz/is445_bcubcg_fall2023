...
See Homework #5 for different options.

notes:
go to HW 5 as a reminder
...
We'll started off with this method, but can run into some limitations when we attempt to build interactive dashboards.
